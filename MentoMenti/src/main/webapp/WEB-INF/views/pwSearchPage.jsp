...
<body class="sidebar-toggled" style="background:#002266;">
                        ...
                        <div class="row text-center">
                            <div class="col-lg-6" style="max-width: 100%; flex: 0 0 100%;">
                                ...
                                <div class="p-3" style="text-align:center;">
                                    <!-- 회원가입 폼 태그 -->
                                    <form class="user" name="pwSearchForm" action="#" method="post" style="width:100%;">
                                    	<div class="searchinfo" style="margin:0 auto; width:50%;">
                                    			<div class="form-group" style="display:flex;">
                                        	<!-- 아이디 입력 -->
                                            		<input type="text" class="form-control form-control-user" name="id" id="id" placeholder="아이디">
                                        		</div>
                                      ...
                                      <div style="float:right; width:100%;">
                                    	...
                                    	<input type="button" class="btn btn-user btn-block" value="비밀번호 찾기" onclick="checkInfo()" style="margin-top:0; float:right; display: inline; width : 45%; background:#002266; color:white;">                                                                              	
                                     </div>
                                    </form>
                                </div>
                            </div>
	...
	<script>
		...
		function checkInfo(){
			...
			url = "confirmPw?id="+form.id.value+"&name="+form.name.value+"&birth="+form.year.value+"-"+form.month.value+"-"+form.day.value+"&email="+form.email1.value+"@"+form.email2.value;
			open(url,"confirm",
